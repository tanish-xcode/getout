  ...
  return (
    <div style={{ minHeight: "100svh" }}>
      ...
      <div style={{ padding: "24px 20px 0" }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, color: "#fff", lineHeight: 1.2, letterSpacing: "-0.02em", marginBottom: 16 }}>
          {event.title}
        </h1>
        ...
        >
          ...
          <div
            style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              boxShadow: "0 0 0 8px rgba(242,107,58,0.20)",
              zIndex: 1,
            }}
          >
  ...
  return (
    <div className="avatar-stack">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          style={{ width: 28, height: 28, borderRadius: 9999, background: colors[i % colors.length], border: "2px solid var(--color-bg-surface)", flexShrink: 0 }}
        />
      ))}
    </div>
  );
